...
### 1. 의존성 확인
- Python 3.13 가상환경: `C:\AI_WORKSPACE\AGENTS\STRATEGY_ANALYSIS\DCSAI\.venv\Scripts\python.exe`
- `dcs-ai-cli` 설치 + OAuth 인증 완료 (Claude Code MCP로 인증 시 영속됨)

### 2. Git 원격 연결 + 첫 push
```bash
cd "C:/AI_WORKSPACE/AGENTS/STRATEGY_ANALYSIS/DCSAI/project_file/매출리뷰용 어플"
...
관리자 PowerShell:
```powershell
cd "C:/AI_WORKSPACE/AGENTS/STRATEGY_ANALYSIS/DCSAI/project_file/매출리뷰용 어플/scripts"
./setup_scheduler.ps1
```
